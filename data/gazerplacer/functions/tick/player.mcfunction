...
#> private
# @private
    #declare score_holder #GazerPlacer.HaveRod
...
# spawning checker
    ...
    scoreboard players set #GazerPlacer.HaveRod Ashen.Global.Temporary 0
    execute if entity @s[nbt={SelectedItem: {id: "minecraft:stick", tag: {Ashen: {GazerPlacer: {Item: 1b}}}}}] run scoreboard players set #GazerPlacer.HaveRod Ashen.Global.Temporary 1
    execute if entity @s[nbt={Inventory: [{id: "minecraft:stick", Slot: -106b, tag: {Ashen: {GazerPlacer: {Item: 1b}}}}]}] run scoreboard players set #GazerPlacer.HaveRod Ashen.Global.Temporary 1
    execute if score #GazerPlacer.HaveRod Ashen.Global.Temporary matches 1 run function gazerplacer:interaction/spawn
    execute if score #GazerPlacer.HaveRod Ashen.Global.Temporary matches 0 run function gazerplacer:interaction/kill
    scoreboard players reset #GazerPlacer.HaveRod Ashen.Global.Temporary
