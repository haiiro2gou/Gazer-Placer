...
# exec
    execute if score $Match Ashen.GazerPlacer.Temporary matches 0 as @a[gamemode=!adventure,gamemode=!spectator,tag=this,limit=1] run function gazerplacer:use/main
