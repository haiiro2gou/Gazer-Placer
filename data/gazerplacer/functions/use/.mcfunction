...
# exec
    execute if score $Match Ashen.GazerPlacer.Temporary matches 0 as @a[gamemode=!adventure,gamemode=!spectator,tag=this,limit=1] at @s run function gazerplacer:use/main
