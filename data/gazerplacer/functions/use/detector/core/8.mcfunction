#> gazerplacer:use/detector/core/8
# @within function
#   gazerplacer:use/detector/core/4
...
# if flag remains, go deep
    execute if score $8 Ashen.GazerPlacer.Detector matches 1 positioned ^ ^ ^-0.03125 run function gazerplacer:use/detector/core/16
    execute if score $8 Ashen.GazerPlacer.Detector matches 1 positioned ^ ^ ^0.03125 run function gazerplacer:use/detector/core/16
