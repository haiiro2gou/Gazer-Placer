...
# 通知
    execute if data storage gazerplacer:player Config{NotifyResult: 1b} run tellraw @s [{"text": "", "clickEvent": {"action": "run_command", "value": "/trigger Ashen.GazerPlacer.Trigger set 1"}, "hoverEvent": {"action": "show_text", "value": [{"translate": "Ashen.GazerPlacer.Config.NotifyResult.Lore", "fallback": "Display execution results"}]}, "extra": [{"text": "[✓] ", "color": "green", "bold": true}, {"translate": "Ashen.GazerPlacer.Config.NotifyResult.Title", "fallback": "NotifyResult"}]}]
    execute if data storage gazerplacer:player Config{NotifyResult: 0b} run tellraw @s [{"text": "", "clickEvent": {"action": "run_command", "value": "/trigger Ashen.GazerPlacer.Trigger set 1"}, "hoverEvent": {"action": "show_text", "value": [{"translate": "Ashen.GazerPlacer.Config.NotifyResult.Lore", "fallback": "Display execution results"}]}, "extra": [{"text": "[✗] ", "color": "red", "bold": true}, {"translate": "Ashen.GazerPlacer.Config.NotifyResult.Title", "fallback": "NotifyResult"}]}]
